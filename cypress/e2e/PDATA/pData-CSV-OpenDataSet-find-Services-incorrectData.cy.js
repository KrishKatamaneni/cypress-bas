...
describe("download pData openCanada CSV services equivalent to beta and data analysis ",()=>{
   
   let lineCount = 0 ;
   
   it('1: download openCanada CSV services equivalent to beta and read file(wait 5-7 min)',()=>{
 
    cy.downloadFile('https://beta.buyandsell.gc.ca/procurement-data/csv/tender/services',
    ...
    it('2: Open downloaded csv for Services and read file',()=>{

       cy.readFile('cypress/downloads/tpsgc-pwgsc_ao-t_a_s.csv', 'binary', { timeout: 150000 })
